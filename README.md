...
The application needs to be "feeded" with data and DGEG – Direção-Geral de Energia e Geologia – is an entity that maintains a [website](http://www.precoscombustiveis.dgeg.pt/) dedicated to provide all information about existing stations as fuel prices, localization, available services, etc. Since 2012, DGEG provides a web service to integrate their data with any kind of applications.
